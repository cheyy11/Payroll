...
<!-- Custom CSS to override AdminLTE styles -->
...
<body class="hold-transition login-page"> <!-- Updated Background Color -->
    <div class="login-box">
        <div class="login-logo">
        <a href="#" class="logo">
            <img src="img/pcu.ico" alt="logo">
        ...
        <div class="login-box-body">
            ...
            <form method="POST" role="form" data-toggle="validator" id="login-form">
                ...
                <button type="submit" class="btn  btn-block btn-flat" style="background-color: #002583; color: white;">Login</button><br>
                <a href="registration/newreg.php">
    <button type="button" class="btn btn-block btn-flat" style="background-color: #002583; color: white;">Register</button>
                </a>
            </form>
        </div>
    </div>
