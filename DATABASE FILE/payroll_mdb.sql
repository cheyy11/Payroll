...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2024 at 07:18 AM
...
(12, 'WY01', '2024-04-16', 'punchin', '19:26:56', '8'),
(13, 'WY01', '2024-04-16', 'punchout', '19:27:24', '');
...
INSERT INTO `wy_employees` (`emp_id`, `emp_code`, `emp_password`, `first_name`, `last_name`, `dob`, `gender`, `merital_status`, `nationality`, `address`, `city`, `state`, `country`, `email`, `mobile`, `telephone`, `identity_doc`, `identity_no`, `emp_type`, `joining_date`, `photo`, `department`, `bank_name`, `account_no`, `created`) VALUES
(6, 'WY01', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'KD', 'Williams', '04/01/1995', 'male', 'Single', 'American', '2424  Boggess Street', 'Dallas', 'TX', 'US', 'jstrmena@gmail.com', '2457878540', '014577854', 'Passport', '012345678', 'Permanent position', '01/29/2019', 'WY01.jpg', 'WEB', 'Demo Bank', '012457854512', '2021-04-12 13:54:49'),
(7, 'WY02', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Leo', 'Allen', '04/01/1993', 'male', 'Registered partnership', 'American', '4265  Jefferson Street', 'Norfolk', 'VA', 'US', 'leoallen06905@gmail.com', '2450157695', '1245785540', 'Passport', '914575421', 'Permanent position', '04/01/2020', 'WY02.jpg', 'Marketing', 'Grand Summit Bank Inc.', '69529712540', '2021-04-14 13:18:32'),
(8, 'WY03', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Christen', 'Moore', '04/20/1995', 'female', 'Single', 'American', '518  Evergreen Lane', 'Los Angeles', 'CA', 'US', 'moorechristen@gmail.com', '4578545555', '4547854520', 'Passport', '100035420', 'Part-time employee', '04/01/2021', 'WY03.jpg', 'General', 'Crest Bank', '87529722555', '2021-04-14 14:23:30'),
(9, 'WY04', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Stephen', 'Denn', '10/12/1992', 'male', 'Registered partnership', 'American', '3007  Carolina Avenue', 'Loveland', 'CO', 'US', 'stephen@gmail.com', '3457856970', '1045786310', 'Passport', '321457852', 'Intern', '04/14/2021', 'WY04.jpg', 'IT', 'Federal Bank', '273794443158', '2021-04-14 15:49:34'),
(10, 'WY05', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Agnes', 'Miller', '07/29/1993', 'female', 'Single', 'American', '4211 Rubaiyt Road', 'Grand Rapids', 'Michign', 'US', 'agnesm88d@gmail.com', '3247548880', '2457778540', 'Passport', '245785000', 'Permanent position', '10/15/2020', 'WY05.jpg', 'IT', 'Centreville Bank', '4201483626', '2021-04-14 19:22:17');
...
(22, 'Test Holiday', 'Test description', '04/12/2024', 'compulsory');
...
INSERT INTO `wy_leaves` (`leave_id`, `emp_code`, `leave_dates`, `leave_message`, `leave_type`, `leave_status`, `apply_date`) VALUES
(1, 'WY01', '04/13/2021', 'this is a demo leave message', 'Sick Leave', 'approve', '2021-04-13 10:09:02'),
(3, 'WY03', '04/15/2021,04/17/2021', 'Dear admin, i\'d like to apply leave for 2 days as i\'ve been a regular employee since my first day at office. And now, i finally got to rest and spend some time with my family too!', 'Casual Leave', 'reject', '2021-04-14 15:47:06'),
(4, 'WY05', '04/15/2021,04/23/2021', 'i wont be able to join office as i\'ve been suffering from a rough common cold and fever. so, i\'d like to request a leave for week', 'Sick Leave', 'reject', '2021-04-14 19:15:11'),
(5, 'WY01', '04/25/2024', 'test message', 'Leave Without Pay', 'approve', '2024-04-19 18:26:24'),
(6, 'WY01', '04/25/2024', 'test message', 'Leave Without Pay', 'approve', '2024-04-19 18:26:29');
...
(17, 'SSS', 'Tax', 'deductions'),
(18, 'Pag-ibig', 'Tax', 'deductions'),
(19, 'Phil Health', 'Tax', 'deductions'),
(21, '15th Month Pay', '15th Month Pay', 'earnings');
...
(253, 'WY01', 'SSS', 254.00, 41000.00, 1500.00, 39500.00, 'deductions', 'October 07, 2024', '2024-10-07 19:42:27'),
(254, 'WY01', 'SSS', 1500.00, 41000.00, 1500.00, 39500.00, 'deductions', 'October 07, 2024', '2024-10-07 19:43:38'),
(255, 'WY01', 'Basic Salary', 40000.00, 41000.00, 1500.00, 39500.00, 'earnings', 'October 07, 2024', '2024-10-07 19:43:38'),
(256, 'WY01', 'Overtime', 1000.00, 41000.00, 1500.00, 39500.00, 'earnings', 'October 07, 2024', '2024-10-07 19:43:38');
...
--
ALTER TABLE `wy_payheads`
  MODIFY `payhead_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `wy_pay_structure`
--
ALTER TABLE `wy_pay_structure`
  MODIFY `salary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
