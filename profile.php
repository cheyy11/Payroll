            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#employee-info">Employee Info</a></li>
                        <li><a data-toggle="tab" href="#bank-details">Bank Details</a></li>
                    </ul>

                    <form method="POST" role="form" data-toggle="validator" id="profile-form">
                        <div class="tab-content">
                            <div id="employee-info" class="tab-pane fade in active">
                                <div class="row">
                                                ...
                                                <option value="female" <?php echo $data['gender']=='female'?'selected':''; ?>>Female</option>
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="number" class="form-control" name="mobile" id="mobile" value="<?php echo $data['mobile']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="telephone">Telephone </label>
															<input type="number" class="form-control" name="telephone" id="telephone" value="<?php echo $data['telephone']; ?>" />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="number" class="form-control" name="identity_no" id="identity_no" value="<?php echo $data['identity_no']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="datepicker" class="form-control datepicker" name="joining_date" id="joining_date" value="<?php echo $data['joining_date']; ?>" required />
														</div>
													</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="account_no" id="account_no" value="<?php echo $data['account_no']; ?>" required />
                                        </div>
                                    </div>
                                    <!-- Add more bank details fields if necessary -->
                                </div>
                            </div>
                        </div>
